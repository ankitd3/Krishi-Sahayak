  ...
  <body class="bg-light">
    ...
    <main role="main" class="container">
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">
        <img class="mr-3" src="Images/q.png" alt="" width="48" height="48">
        <div class="lh-100">
    ...
    <br><hr><br>
      ...
      <input class="btn btn-primary" type="submit" name="submit_q" value="UPLOAD">
    </form>

		<!-- <label>TEXT</label>
		<input type="text" name="textQ" placeholder="Enter your query here">
		<input type="submit" name="submit_text" value="TEXT Q"> -->
