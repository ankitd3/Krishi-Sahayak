...
<body>
    ...
    <div class="container">
        <!-- tell me how to display the different question types here-->
    </div>

    <!--starting with different ans types here-->
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a style="color:#2b5e40" class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
            ...
            <li class="nav-item">
                <a style="color:#2b5e40" class="nav-link" id="text-tab" data-toggle="tab" href="#text1" role="tab" aria-controls="text" aria-selected="false">
                Text</a>
            </li>
        </ul>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="text1" role="tabpanel" aria-labelledby="text-tab">
